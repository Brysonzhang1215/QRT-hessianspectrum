"""Carleman coefficient extraction using JAX autograd."""
...
def build_vector_field(loss_fn: LossFn, w_dim: int) -> Callable[[jnp.ndarray, object], jnp.ndarray]:
    """Return the vector field vdot = [grad_w L, -grad_u L]."""
...
def compute_coeffs(
    ...
    """Compute F0, F1, and optionally F2 for the Carleman expansion."""
...
def verify_linear_approx(
    ...
    """Assert the linear approximation matches the true vector field."""
